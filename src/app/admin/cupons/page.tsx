  ...
  return (
    <div style={{ padding: "32px 36px", maxWidth: 820 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
        <div>
          <h1 style={{ color: "white", fontWeight: 900, fontSize: 22 }}>🎟️ Cupons globais</h1>
          <p style={{ color: "rgba(255,255,255,0.3)", fontSize: 13, marginTop: 3 }}>Válidos em qualquer loja da plataforma</p>
        </div>
      ...
      {criando && (
        <div style={{ background: "#111", borderRadius: 16, border: "1px solid rgba(249,115,22,0.2)", padding: "20px 22px", marginBottom: 24, display: "flex", flexDirection: "column", gap: 14 }}>
          <p style={{ color: "white", fontWeight: 700, fontSize: 14 }}>Novo cupom global</p>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", marginTop: 48 }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.4)", fontWeight: 600 }}>Nenhum cupom global criado</p>
        </div>
      ) : (
          ...
          {cupons.map(c => (
            <div key={c.id} style={{
              ...
              <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
                <button onClick={() => toggleAtivo(c)} style={{ padding: "7px 14px", borderRadius: 10, border: "1px solid rgba(255,255,255,0.1)", background: "transparent", color: "rgba(255,255,255,0.4)", fontSize: 12, fontWeight: 700, cursor: "pointer" }}>
